  ...
  return (
    <header className="sticky top-0 z-10 flex h-16 items-center gap-4 border-b border-rose-200 bg-white/80 backdrop-blur-sm px-6">
      <div className="flex-1">
        <h1 className="text-lg font-semibold bg-gradient-to-r from-rose-600 to-fuchsia-600 bg-clip-text text-transparent">
        ...
        <div className="h-0.5 w-24 bg-gradient-to-r from-rose-500 to-fuchsia-500 rounded-full mt-1" />
      </div>
